...
export const EquipoFormConfig: { [key: string]: EquipoFormField[] } = {
  ...
  "Celular": [
    ...
    { name: "almacenamiento", label: "Tipo de Almacenamiento", type: "text", placeholder: "Ej: UFS 4.0" },
  ...
  "Notebook": [
    ...
    { name: "almacenamiento", label: 'Tipo de Almacenamiento', type: 'text', placeholder: 'Ej: SSD NVMe' },
  ...
  "Data Show": [
    ...
    { name: 'almacenamiento', label: 'Tipo de Almacenamiento', type: 'text', placeholder: 'Ej: Memoria Interna' },
  ...
  "Tablet": [
    ...
    { name: 'almacenamiento', label: 'Tipo de Almacenamiento', type: 'text', placeholder: 'Ej: SSD o eMMC' },
    { name: 'cantidadAlmacenamiento', label: 'Capacidad de Almacenamiento (GB)', type: 'number', placeholder: 'Ej: 256' },
  ...
  "All in One": [
    ...
    { name: 'ram', label: 'RAM (GB)', type: 'number', placeholder: 'Ej: 8' },
    { name: 'almacenamiento', label: 'Tipo de Almacenamiento', type: 'text', placeholder: 'Ej: SSD' },
    { name: 'cantidadAlmacenamiento', label: 'Capacidad de Almacenamiento (GB)', type: 'number', placeholder: 'Ej: 512' },
